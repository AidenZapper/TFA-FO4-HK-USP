...
SWEP.VElements = {
	...
	["compensator_match"] = { type = "Model", model = "models/weapons/attachments/c_matchcomp_fo4usp.mdl", bone = "Weapon", rel = "", pos = Vector(-0.04, -6.5, 2.58), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
...
SWEP.WElements = {
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_m9.mdl", bone = "A_Underbarrel", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "LaserPistol", rel = "laser", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
	["suppressor_rydershort"] = { type = "Model", model = "models/weapons/attachments/c_matchcomp_fo4usp.mdl", bone = "WeaponOptics1Helper", rel = "", pos = Vector(-0.04, -7.3, 2.58), angle = Angle(0, 90, 0), size = Vector(1.25, 1.25, 1.25), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["compensator_match"] = { type = "Model", model = "models/weapons/attachments/c_rydershort_fo4usp.mdl", bone = "WeaponOptics1Helper", rel = "", pos = Vector(-0.04, -7.3, 2.58), angle = Angle(0, 90, 0), size = Vector(1.25, 1.25, 1.25), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
}
...
SWEP.Attachments = {
	...
	[2] = { offset = { 0, 0 }, atts = { "ins2_br_supp", "fo4_hkusp_ryder_short", "fo4_hkusp_match_comp", "fo4_hkusp_velocity_comp", "fo4_hkusp_osprey" }, order = 2 },
