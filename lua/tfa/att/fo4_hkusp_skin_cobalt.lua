...
ATTACHMENT.Name = "Cobalt"
ATTACHMENT.ShortName = "CBT" -- Abbreviation shown on the bottom left of the icon, generated from name if not defined
ATTACHMENT.Description = {
} -- all colors are defined in lua/tfa/modules/tfa_attachments.lua
ATTACHMENT.Icon = "entities/cobalt.png" -- "entities/tfa_ammo_match.png" -- Full path to the icon, reverts to '?' by default
